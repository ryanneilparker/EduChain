...
app.post('/createCertificate', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const transaction = yield contract.safeMint(wallet.address, studentName, certificateName, message);
